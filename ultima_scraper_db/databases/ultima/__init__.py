...
class TestOnlyFans:
    __abstract__ = True
    __table_args__ = {"schema": "onlyfans"}


class TestFansly:
    __abstract__ = True
    __table_args__ = {"schema": "fansly"}
...
from ultima_scraper_db.databases.ultima.schemas import management as _
from ultima_scraper_db.databases.ultima.schemas.templates import site as _


def create_merged_metadata(base: UltimaBase | Any):
